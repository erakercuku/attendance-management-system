...
void Attendance::assign_roles(void)
{
    ...
    // Use Input class to get a valid username
    ...
    // Use Input class to get a valid role (1 - Admin, 2 - Manager, 3 - User)
    Input::get("Enter the new role (1: Admin, 2: Manager, 3: User): ", new_role, 1, 3, Input::valid_opt);
